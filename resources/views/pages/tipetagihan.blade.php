...
<div id="main-content">
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-3 pl-0">
            <a type="button" href="{{url('/data/tipetagihan/tambah')}}" class="btn w-100"
                style="background: #241937; color: #ffffff; box-shadow: 1px 3px 6px rgba(0,0,0,0.1);">Tambah Data</a>
        </div>
    </div>
    ...
    <div class="row mt-0 justify-content-end mr-2">
        <p style="font-weight: 400;"><span id="custom-count">{{$tipetagihan->count()}}</span> dari {{ $tipetagihan->count() }} Data Ditampilkan</p>
    </div>
